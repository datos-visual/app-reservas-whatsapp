...
// Agenda, citas manuales, franjas bloqueadas y horarios: routes/agenda.js.
// OJO: por detrás de app.use('/api', authMiddleware), nunca por delante.
app.use(require('./routes/agenda'));

// Backoffice del administrador: sus rutas viven en routes/admin.js.
// OJO: este montaje TIENE que ir por detrás de app.use('/api', authMiddleware).
// Si sube por encima, las rutas quedan abiertas sin token y nada falla.
app.use(require('./routes/admin'));

// Catálogo, plan, conexiones y módulos de la propia tienda: routes/tienda.js.
// OJO: por detrás de app.use('/api', authMiddleware), nunca por delante.
