    ...
    <main className="flex min-h-screen items-center justify-center px-6 py-10">
      <div className="w-full max-w-md rounded-xl border border-[#d9d9d9] bg-white p-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-[#666666]">Identificador del número (phone_number_id) *</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#666666]">ID de la cuenta de WhatsApp Business (waba_id, opcional)</label>
            <input
