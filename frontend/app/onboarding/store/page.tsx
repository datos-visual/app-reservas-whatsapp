  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-10">
      <div className="w-full max-w-md rounded-xl border border-[#e7e5de] bg-white p-6">
        ...
        <p className="mb-6 text-sm text-[#8a8378]">Paso 2 de 4 — los datos básicos de tu tienda.</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-[#8a8378]">Nombre del negocio *</label>
            <input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block text-xs text-[#8a8378]">Zona horaria</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-xs text-[#8a8378]">Duración de cita</label>
              <select
          ...
          <div>
            <label className="mb-1 block text-xs text-[#8a8378]">Email del negocio (opcional)</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#8a8378]">Teléfono del negocio (opcional)</label>
            <input
