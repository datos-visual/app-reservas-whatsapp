    ...
    <main className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-xl border border-[#d9d9d9] bg-white p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-[#666666]" htmlFor="email">Email</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#666666]" htmlFor="password">Contraseña (mín. 8 caracteres)</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#666666]" htmlFor="password2">Repite la contraseña</label>
            <input
