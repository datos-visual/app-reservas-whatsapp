...
export default function RegisterPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-xl border border-[#c9c9c9] bg-[#e6e6e6] p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-[#6e6e6e]" htmlFor="email">Email</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#6e6e6e]" htmlFor="password">Contraseña (mín. 8 caracteres)</label>
            <input
          ...
          <div>
            <label className="mb-1 block text-xs text-[#6e6e6e]" htmlFor="password2">Repite la contraseña</label>
            <input
        ...
        <p className="mt-4 text-xs text-[#6e6e6e]">
          ¿Ya tienes cuenta?{' '}
